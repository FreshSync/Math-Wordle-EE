...
# Information and probability of every single word in google sheets
...
outPath = "G:/My Drive/Wordle_All_Math.xlsx"

df = pd.DataFrame({"Word": allWordData, "Mean Probability": allProbData, "Mean Information": allInfoData, "Most Probable Color": allColorData})
